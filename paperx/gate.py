...
de style : le banc d'essai ne représente pas
...
Le drapeau ne doit passer à vrai que dans un dépôt distinct, après essais réels
et revue matériel — pas par un simple changement de valeur ici.
"""

from __future__ import annotations

#: Sortie machine indisponible par construction dans ce dépôt.
...
GATE_REASON = (
    ...
    "et de levée, obstacles physiques et état machine ne sont pas représentés "
    "dans ce banc d'essai. Aucun profil ne peut devenir « prêt machine » ici."
)
